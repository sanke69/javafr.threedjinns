...
public class GLTextureCubeMap extends AbstractTextureBase {
	int					m_Texture;          ///<Identifiant OpenGL de la texture>

    public GLTextureCubeMap(int _w, int _h, int _pxl_size, PixelFormat _format, ByteBuffer _data, TextureFlag... _flags) {
	...
	public void enable(int _unit) {
        ...
        gl.glTexParameteri(GL.GL_TEXTURE_CUBE_MAP, GL2.GL_TEXTURE_WRAP_S,    GL.GL_CLAMP_TO_EDGE);			//GL_CLAMP_TO_EDGE - GL_REPEAT
        gl.glTexParameteri(GL.GL_TEXTURE_CUBE_MAP, GL2.GL_TEXTURE_WRAP_T,    GL.GL_CLAMP_TO_EDGE);			//GL_CLAMP_TO_EDGE - GL_REPEAT
        gl.glTexParameteri(GL.GL_TEXTURE_CUBE_MAP, GL2.GL_TEXTURE_WRAP_R,    GL.GL_CLAMP_TO_EDGE);			//GL_CLAMP_TO_EDGE - GL_REPEAT
